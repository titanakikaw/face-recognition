        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                    ...
                    <li><a data-toggle="tab" href="#department"><i class="fa fa-calendar"></i> Department</a>
                    </li>
                ...
                <div class="tab-content custom-menu-content">
                    ...
                    <div id="subject" class="tab-pane notika-tab-menu-bg animated flipInX">
                        <ul class="notika-main-menu-dropdown">
                            ...
                            <li>
                                <a href="manage-subject.php">Manage Subject</a>
                            </li>
                            <li>
                                <a href="enroll-student.php">Enroll Student to Subject</a>
                            </li>
                            <li>
                                <a href="manage-enrolled.php">Manage enrolled Student to Subject</a>
                            </li>
                        </ul>
                    </div>
