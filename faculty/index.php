            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro">
                        ...
                        <li><a data-toggle="tab" href="#attendance"><i class="fa fa-calendar"></i> Attendance</a>
                        </li>
                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="attendance" class="tab-pane notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                <li><a href="attendance.php">Check Attendance</a>
                                </li>
                                <li><a href="manage.php">Manage Attendance</a>
                                </li>
                            </ul>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        ...
                        <div style="margin-left:15px"><i class="fa fa-calendar fa-4x text-success"></i></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30">
                        <div class="website-traffic-ctn">
                            ...
                            <p>Number of Presents</p>
                        </div>
                        <div style="margin-left:15px"><i class="fa fa-check fa-4x text-info"></i></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                    <div class="wb-traffic-inner notika-shadow sm-res-mg-t-30 tb-res-mg-t-30 dk-res-mg-t-30">
                        ...
                        <div style="margin-left:15px"><i class="fa fa-times fa-4x text-warning"></i></div>
                    </div>
                </div>
            </div>
        </div>
